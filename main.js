...
console.log(length_array);
for(var b=0;b<length_array;b++){
    display_student_array_sort.push("<h4>NAME-"+name_of_student_array[b]+"</h4>");
...
document.getElementById("displayname_without_comma").innerHTML=remove_commas;
    ...
    function new_update(){
    document.getElementById("displayname_without_comma").innerHTML="<h1>"+name_of_student_array+"</h1>"; 
    }